...
Change fatigue accumulated because the organization launched new transformations before completing existing ones. Each initiative added cognitive load without resolving the previous one. The team's emotional capacity was never measured as a constraint.

**Navigate**

The organization runs no more than two change initiatives simultaneously. New changes are sequenced, not stacked.
