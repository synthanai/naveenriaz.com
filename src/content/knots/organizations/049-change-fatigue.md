...
status: pending
canonical_id: 66
canonical_name: Change Fatigue
custom_comment: |-
  🪢 Read this knot: https://naveenriaz.com/knots/organizations/049-change-fatigue/
...
knot_number: 49
kural_bridge: "Change fatigue is what happens when the organisation has faced so many hardships that defiance has been exhausted."
kural_number: 619
kural_tamil: |-
  தெய்வத்தான் ஆகா தெனினும் முயற்சிதன்
  
    மெய்வருத்தக் கூலி தரும்.
kural_translation: "Laugh when hardship arrives; nothing defeats adversity like defiance."
linkedin_post: |-
  Remember when change felt exciting here?
  
    Your team has survived seven transformations.
  
    Each initiative promised "this time's different."
  
    Nothing changed except their belief in change.
  
    Fatigue isn't resistance. It's earned skepticism.
  
    Finish one thing before starting another.
  
    That exhaustion? It's not laziness. It's experience. ⏳
  
    #108KNOTS #UntanglingChange #Knot049
    💡 Teams that pace their change capacity #thrive.
mbs_layer: BODY
...
punch_line_2: "Change fatigue is what happens when the organisation has faced so many hardships that defiance has been exhausted."
quote_bottom: "Defiance conquers all."
quote_top: "Laugh in the face of hardship."
season: 3
...
untie_question: 'What would change in your organisation if you untangled \"change fatigue\" this week?'
untie_story: 'A company held a \"funeral\" for the old process before launching the new. Mourning enabled moving forward.'
valence: mixed
x_post: |-
  Your team has survived 7 transformations. 🔄
  
  Every initiative promised 'this time's different.' But nothing changed except their belief in change.
  
  Fatigue isn't resistance. It's earned skepticism.
  
  That exhaustion? It's not laziness. It's experience. ⏳
  
  💡 The secret to sustainable growth: Finish one thing before starting another. Pace your change capacity to truly thrive. #UntanglingChange #TeamCapacity
youtube_series: |-
  108 Knots: Organisations
---

Laugh when hardship arrives. Nothing defeats adversity like defiance.
Valluvar prescribes courage. But courage is a renewable resource only when the hardships have purpose.
Your team has survived seven transformations in five years. Digital transformation. Agile transformation. Cultural transformation. Operating model transformation. Customer-centric transformation. AI transformation. And the latest: 'holistic transformation.'
...
Organizational change fatigue works identically: the team still shows up, still attends the workshops, still updates the status reports. But the discretionary effort that makes transformation actually work has been depleted.
The body is present. The commitment left three transformations ago.

Before launching the next change initiative, ask your team one question: 'How many transformations are you currently in the middle of?'
