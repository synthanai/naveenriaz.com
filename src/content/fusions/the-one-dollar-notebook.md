...
No more typed papers. No more online submissions. The reason? AI was "eroding trust" in her classroom. She could no longer tell if her students wrote their essays or if ChatGPT did.

So she removed the technology entirely.

And it worked. She sees scribbles, crossed-out words, misspellings. "Authentic human mess," she calls it. Two students asked to decorate their covers. She is having more fun.
...
She is not anti-technology. She acknowledges AI as a "virtual editor" for non-native speakers. Her concern is specific: typed digital submissions cannot be verified as the student's own work. She does not ban AI from learning. She bans it from assessment. And she genuinely believes that handwriting, as a practice, benefits everyone.
...
The Learning Architect broke it open: the professor's assignment asked students to "analyse a historical source and submit it as a Word document." That is a comprehension task. AI passes comprehension tasks easily.
...
I once asked a student, mid-assignment: "Why are you writing this essay?" He said, "Because it is due Thursday." Not because the topic mattered. Not because the argument was his. Because Thursday.
...
She activates it for verification: "Write by hand so I can see you wrote it."

I activate it for transformation: "Write by hand so YOU can see what you think."
...
| Decade | Technology | Ban Rationale | What Actually Happened |
|--------|-----------|---------------|----------------------|
| 1970s | Calculators | "Students won't learn arithmetic" | Curriculum evolved. Calculators became standard. |
| 1990s | Internet | "Students will plagiarise" | Citation standards evolved. Research capacity exploded. |
| 2000s | Wikipedia | "Unreliable source" | Media literacy became a skill. |
| 2020s | GenAI | "Students will cheat" | We are here. |
...
What if the assignment is: *"Use ChatGPT to generate an analysis. Then, in your notebook, in your own handwriting, write what you agree with, what you disagree with, and why."*
...
| **Identity** (personal judgment) | Forces the student to take a position: "This is what I think." |

The Identity Cartographer named the identity this creates: *"I am someone who thinks WITH AI and thinks BEYOND AI."*

That is more powerful than "I can write without AI" (defensive) or "I can use AI" (dependent).
...
4. **Articulate.** Defend your thinking. Out loud, to a peer, to a class. This is where identity takes shape: "I am someone who can explain why I think what I think."
...
> **Prompt**: "Ask AI to produce an argument that Source A proves the Industrial Revolution was driven by trade, not technology."
> **Evaluate**: Circle three claims that are weak, missing context, or unsupported.
> **Notate** (by hand): Write your stance: what holds, what fails, what you would change.
> **Articulate**: 60-second oral defence with one peer question.
