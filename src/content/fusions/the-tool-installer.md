---
title: "The Tool Installer: Why AI Consulting Is Already a Commodity"
display_title: "The Tool Installer"
...
| The Tool Installer | The Diagnostic Physician |
|:---|:---|
| "Which AI tools do you use?" | "What is your team avoiding?" |
| Audits the tech stack | Audits the decision patterns |
| Builds workflows | Builds capability |
| Revenue: setup fee + retainer | Revenue: diagnostic fee + transformation |
| Client dependency on consultant | Client independence through clarity |
| Commoditises in 18 months | Compounds over years |
| Sells shovels | Reads the terrain |
...
QUESTION: If your AI consulting engagement starts with a tool recommendation, what happens when the tools learn to install themselves? The most-shared skills list of 2026 has no answer, because it never asks the question.

CONTRAST: Most AI consultants walk in and ask "which tools do you need?" The ones who last walk in and ask "what is your team avoiding?" Pharmaceutical sales rep vs. physician. Same clinic. Completely different practice.
-->
