---
title: "The Waterfall Trap: When AI Coding Frameworks Forget How to Think"
display_title: "The Waterfall Trap"
...
![Collision diagram: linear waterfall meets circular adaptive system](/images/collisions/the-waterfall-trap.png)

| Waterfall Framework | Living Framework |
|:---|:---|
| 5 phases, one direction | Circular verbs, any direction |
| Specification precedes architecture | Architecture emerges through exploration |
| Refinement is a phase before completion | Refinement is continuous, never "done" |
| Feedback loops are implicit (or absent) | Feedback loops are the architecture |
| AI fills in boxes | AI reshapes the map |
| Completion is the destination | Learning is the destination |
...
*This fusion emerged from a STEAL on [ruvnet/sparc](https://github.com/ruvnet/sparc) (GitHub, March 2026). The research that grounded it lives in [frameworks/sparc-framework/research.md](/research/sparc-framework).*
...
QUESTION: Why are AI coding frameworks in 2026 using the same linear model that the Agile Manifesto rejected in 2001? 439 stars for a cascade. What if the right shape for intelligence is a compass, not a waterfall?

CONTRAST: Most people think AI coding needs more structure. They're right. But structure is not the same as direction. Five boxes pointing down is a waterfall. Five verbs on a compass is a living system. The tools are the same. The geometry changes everything.
-->
