...
|:---|:---|
| Module boundaries define interfaces | Role boundaries are fuzzy and political |
| APIs expose capabilities explicitly | Capabilities are tacit and relationship-dependent |
| Documentation matches reality | Documentation is aspirational, not descriptive |
| Constraints enable safe modification | Constraints are experienced as bureaucracy |
| AI can navigate, modify, deploy | AI can read docs but not the real organisation |
...
QUESTION: Can an AI agent dropped into your organisation understand who owns what, who decides what, and how decisions flow, without asking twenty people? If not, your organisation is not legible. And illegible organisations cannot be AI-native, no matter how many tools you deploy.

CONTRAST: In software, constraints (module boundaries, APIs, type systems) produce legibility. In organisations, constraints are experienced as bureaucracy. The difference: software constraints enable safe modification. Organisational constraints often prevent modification entirely. The design challenge is organisational boundaries that are enabling, not restricting.
-->
