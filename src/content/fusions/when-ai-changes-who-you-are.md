---
title: "When AI Changes Who You Are, Not Just What You Do"
display_title: "When AI Changes Who You Are"
...
| Skills-Gap Framing | Identity-Renegotiation Framing |
|:---|:---|
| "Learn the tools" | "Rediscover what you bring" |
| Training fixes the problem | Conditions enable the transition |
| Anxiety = resistance | Anxiety = healthy response to genuine loss |
| Speed of adoption = success | Depth of integration = success |
| People must "keep up" | Organisations must hold the space |
| Measures tool usage | Measures identity coherence |
...
QUESTION: What happens to people's sense of self when the things that made them valuable at work can be done by a machine in seconds? A Meta Director of Product calls it "identity renegotiation." Most companies are still calling it a training problem.

CONTRAST: Most organisations treat AI adoption as a tooling challenge: roll out the tools, train the people, measure adoption. The data says something else. The real barrier isn't skills. It's that people are renegotiating who they are, what they contribute, and where they fit. No lunch-and-learn fixes that.
-->
