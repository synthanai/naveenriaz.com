---
title: "SPAR Is Not an AI Feature. It's an Economic Mechanism"
display_title: "SPAR Is Not an AI Feature"
...
| Domain | Failure Name | Counter-Mechanism |
|:---|:---|:---|
| Organisations | Groupthink | Devil's Advocate |
| AI | Sycophancy | Constitutional AI, RLHF |
| Finance | Minsky Moment | Stress testing, risk committees |
| Mathematics | Local Minimum | Simulated annealing, random restarts |
| Academia | Confirmation bias | Blind peer review |
| Military | Tunnel vision | Red team / Blue team |
...
CONTRAST: The AI industry frames multi-agent debate as a technical feature. But structured adversarial friction predates AI by decades: red teaming (military), peer review (academia), stress testing (finance), devil's advocate (organisations). Each domain reinvented the same mechanism independently. The AI delivery mechanism is new. The governance pattern is 50 years old.
-->
