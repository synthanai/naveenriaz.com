---
title: "The OT Mirror: What a 100-Year-Old Health Profession Reveals About Organisational DNA"
display_title: "The OT Mirror"
...
![The OT Mirror: MOHO's three layers (Volition, Habituation, Performance Capacity) map precisely to SYNTHAI's MBS architecture (Soul, Mind, Body). Two frameworks, one century apart, same structural truth.](/images/collisions/the-ot-mirror.png)
...
QUESTION: Occupational therapy's Model of Human Occupation has 15,000+ citations and 40 years of clinical evidence. It maps Volition, Habituation, and Performance Capacity as the architecture of human functioning. SYNTHAI maps Soul, Mind, and Body as the architecture of living organisations. Neither influenced the other. What does it mean when two unrelated fields discover the same structure?

CONTRAST: In the 1950s, occupational therapy stripped out its Soul layer (volition, meaning, purpose) to gain medical credibility. It focused only on Body (exercises, measurements, range of motion). The profession nearly died. It took 30 years and a philosophical rebellion to recover. Organisations do the same thing every day: optimise for execution, ignore purpose. OT already knows how that story ends.
-->
